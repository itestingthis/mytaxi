...
const LocationSection = () => {
  const locations = [
    { name: 'Kaş Merkez', time: '30 dk', popular: true },
    { name: 'Kalkan', time: '10 dk', popular: true },
    { name: 'Antalya Havalimanı', time: '3.30 saat', popular: true },
    { name: 'Demre', time: '1 saat', popular: false },
    { name: 'Myra Antik Kenti', time: '1.20 saat', popular: false },
    { name: 'Saklıkent Kanyonu', time: '35 dk', popular: true }
  ];
